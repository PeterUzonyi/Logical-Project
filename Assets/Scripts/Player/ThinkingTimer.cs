...
public class ThinkingTimer : MonoBehaviour
{
    ...
    void Update()
    {
        if (PhotonNetwork.IsConnected) return; // Online-ban az event kezeli
    ...
    /// <summary>
    /// Indítja vagy újraindítja a visszaszámlálót.
    /// Lokális módban a TurnManager/Player hívja körváltáskor.
    /// </summary>
    public void StartTimer()
    {
        if (PhotonNetwork.IsConnected) return; // Online-ban az OnlineTurnManager vezérel
    ...
    /// <summary>
    /// Visszaállítja az idõzítõt a teljes értékre (akció végrehajtásakor hívd).
    /// </summary>
    public void ResetTimer()
    {
        //if (PhotonNetwork.IsConnected) return; // Online-ban az RPC_SetTurn reseteli
    ...
    /// <summary>
    /// Megállítja az idõzítõt (pl. kör vége után, hogy ne fusson feleslegesen).
    /// </summary>
